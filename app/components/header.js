      ...
      >
        ...
        <div className=" text-white font-normal md:text-[20px] flex-row p-2 text-[50px] \ md:flex">
          ...
          <span className="md:ml-210 space-x-3 ml-5">
            <button
            className="hover:text-[#d38f28]" onClick={() => router.push("/blog")}>Blog</button>  <button className="hover:text-[#d38f28]"
            onClick={() => router.push("/menu")}>Menu</button>    <button className="hover:text-[#d38f28]"
            onClick={() => router.push("/aboutus")}>About us </button>
          </span>
        </div>
        <div>
          <img
