...
export default function Menu({image,name,price})
{
    return (
        <div>
            ...
            <button className="border rounded-full   dark:bg-[#826A45] dark:hover:bg-white dark:text-black dark:hover:text-black text-black md:px-30 p-3 m-4 text-[70px] md:text-sm hover:bg-[#826A45] hover:text-white transition ">
              Add to Cart
            </button>
          </div>
        </div>
