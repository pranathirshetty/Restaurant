...
export default function Register()
{
    return (
        <div>
        <div className="bg-gray-800  text-white justify-between p-2 md:w-auto w-430 items-center ">
          <div className="text-white rounded-sm flex row   ">
            ...
            <img
              ...
              alt="image not found "
            />
            <button className="bg-green-600 ml-300 cursor-pointer p-1 m-2 rounded-xl">
              Buy Now
            </button>
          </div>
        </div>
 ...
 <img
  ...
  <div className="bg-cover bg-center md:h-120 h-200 md:w-auto w-430 border-transparent"    style={{
    ...
    className="ml-20 p-5 "
       ...
       height="50"
       width="150"/>
        <div className=" text-white font-normal text-[18px]  row p-2 flex justify-center mr-40 mt-[-70px]">
          <span className="ml-40 space-x-3 ">
        ...
        </div> <div className="text-white text-[115px] md:text-[50px] font-bold font-[Marcellus]  flex justify-center mt-35">Register Page</div> 
      <div className="text-white flex justify-center  text-[55px] md:text-[20px]">Home register </div>
        </div>
        <div className="flex md:flex-row flex-col ">
       <div className="absolute md:top-40 md:left-10 top-10 left-10 h-10 w-10">
  <img 
    className=""
  ...
  <div className="md:ml-30 md:mt-10 ml-40 w-350  ">
    ...
    <div className="md:text-3xl md:ml-1 ml-250  text-[100px] whitespace-nowrap text-[#826A45] ">CREATE AN ACCOUNT</div>  
...
<div className="flex md:flex-row flex-col md:gap-4 gap-10 md:m-4 m-10">
  <div className=" border border-gray-800 pl-20 pr-20 pt-2  m-2 text-[50px] md:ml-1 ml-100  md:text-[20px] rounded-md flex flex-row cursor-pointer">
    ...
    <div className=" border border-gray-800 pl-20 pr-20 pt-2  m-2 text-[50px] md:ml-1 ml-100  md:text-[20px] rounded-md flex flex-row cursor-pointer">
      <img
     className="md:h-6 h-20 mr-2 mt-1 " src="https://cdn-icons-png.flaticon.com/128/3128/3128304.png"
      />Facebook</div>
